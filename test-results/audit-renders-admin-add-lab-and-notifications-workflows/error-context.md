...
- Name: audit.spec.js >> renders admin add-lab and notifications workflows
- Location: src\test\e2e\audit.spec.js:110:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/admin/add-lab
Call log:
  - navigating to "http://127.0.0.1:4173/admin/add-lab", waiting until "load"

...
- Name: audit.spec.js >> renders results workflow and barcode actions
- Location: src\test\e2e\audit.spec.js:90:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/results
Call log:
  - navigating to "http://127.0.0.1:4173/results", waiting until "load"

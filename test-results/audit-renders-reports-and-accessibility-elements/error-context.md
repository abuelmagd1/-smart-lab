...
- Name: audit.spec.js >> renders reports and accessibility elements
- Location: src\test\e2e\audit.spec.js:98:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/reports
Call log:
  - navigating to "http://127.0.0.1:4173/reports", waiting until "load"

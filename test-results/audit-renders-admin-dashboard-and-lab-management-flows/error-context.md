...
- Name: audit.spec.js >> renders admin dashboard and lab management flows
- Location: src\test\e2e\audit.spec.js:104:1

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://127.0.0.1:4173/admin
Call log:
